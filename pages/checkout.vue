...
<template>
  <div class="bg-gray-medium pb-28">
    ...
    <FormKit
      ...
      @submit="onSubmit"
    >
      <div class="content-container grid grid-cols-1 gap-7 xl:grid-cols-3 xl:gap-8">
        <div class="rounded-lg bg-light p-6 md:p-8 lg:col-span-2 2xl:p-12">
          <div>
            ...
            <div class="grid grid-cols-1 gap-x-4 md:grid-cols-2">
              ...
              <FormKit
                type="tel"
                label="Phone Number"
                validation="matches:\+\d{1,3}[- ]?)?\d{8,11}$/"
                :validation-messages="{
          ...
          <div>
            ...
            <div class="grid grid-cols-1 gap-x-4 md:grid-cols-2">
              ...
              <div>
                <FormKit type="radio" name="paymentMethod" value="eMoney" label="e-Money" validation="required" />
                <FormKit
                  type="radio"
                  name="paymentMethod"
                  value="cash"
