...
<template>
  <footer class="bg-gray-dark">
    <div class="content-container">
      <div class="relative">
        <div class="absolute left-1/2 top-0 h-1 w-24 -translate-x-1/2 bg-primary md:left-0 md:translate-x-0"></div>
        <div class="grid grid-cols-2 gap-y-12 pb-11 pt-14">
          <div class="order-1 col-span-2 mx-auto md:mx-0 lg:col-span-1">
            <NuxtImg width="143" height="25" src="/logo.svg" />
          </div>

          <div
            class="order-2 col-span-2 flex flex-col items-center justify-center gap-8 md:flex-row md:justify-start lg:col-span-1 lg:justify-end"
          >
          ...
          <p class="order-3 col-span-2 mb-0 text-center text-light opacity-50 md:text-left lg:col-span-1">
          ...
          <div
            class="order-6 col-span-2 flex items-center justify-center gap-4 md:col-span-1 md:justify-end lg:order-5 lg:items-end"
          >
            <NuxtLink class="hover-light" to="#">
