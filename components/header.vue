...
console.log(cartStore.itemsInCart);
</script>
    ...
    <div class="relative">
      <div class="content-container relative" :class="[showMobileMenu && 'fixed left-0 top-0']">
        <div class="flex items-center justify-between gap-11">
          ...
          <button
            ref="navRefs"
            class="hover-light group/cart transition-all ease-in-out"
          ...
          >
            <div class="relative">
              ...
              <div
                ...
                class="absolute -right-1 -top-2 flex h-[18px] w-[18px] items-center justify-center rounded-full bg-primary text-[11px] transition-colors group-hover/cart:text-light"
              >
                <span v-if="cartStore.itemsInCart <= 9">{{ cartStore.itemsInCart }}</span>
                <span v-else class="flex">9<span class="text-[8px]">+</span></span>
              </div>
            </div>
          </button>
        </div>
